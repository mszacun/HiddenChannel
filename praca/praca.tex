...
\chapter{Wstęp teoretyczny}
    ...
    \section{Steganoanaliza}
        ...
        niego sposób prowadzenie analizy, oraz \emph{steganoanalizę ślepą(ang. blind)},
        ...
        się, że do zorganizowania ataków na wieże World Trade Center, 11 wrześnie 2001 roku,
        ...
        Najpowszechniejszeym zastosowaniem steganoanalizy, podobnie jak kryptoanalizy,
        ...
        w ramach badania bezpieczeństwa, zazwyczaj sprawdza się, jak cięzko
        jest odczytać treść ukrytej wiadomości, po odkryciu jej istnienia.
        Pojemność(bądź przeływność, w przpyadku steganoanalizy sieciowej), czyli
